const asciiTable = {
    ...
    2: " STX ( Start of Text )",
    3: " ETX ( End of Text, hearts card suit )",
    4: " EOT ( End of Transmission, diamonds card suit )",
    5: " ENQ ( Enquiry, clubs card suit )",
    6: " ACK ( Acknowledgement, spade card suit )",
    7: " BEL ( Bell )",
    8: " BS ( Backspace )",
    9: " HT ( Horizontal Tab )",
    10: " LF ( Line feed )",
...
function lookForAscii(number)
{
    return asciiTable[number];
}

lookForAscii(randomNumber);